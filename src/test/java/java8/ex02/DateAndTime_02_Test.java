...
public class DateAndTime_02_Test {
    ...
    public void test_localDate_parse() {
        ...
        LocalDate result1 = LocalDate.parse("1990-01-10"); // format ISO
    ...
    public void test_localDate_format() {
        ...
        LocalDate dateLocale = LocalDate.of(2015, 3, 11);

        // TODO Formatter la date pour que le test soit passant
        String result = dateLocale.format(DateTimeFormatter.ofPattern("dd - MM - yyyy"));
